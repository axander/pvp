...
export const environment: Environment = {
  ...
  assets_path: "/wordpress/wp-content/plugins/Custom-Plugin-Digicopy-Online/app/",
  mocks: {
    path: 'assets/mocks/'
  },
  api: {
    translations: "/wordpress/wp-content/plugins/Custom-Plugin-Digicopy-Online/app/assets/i18n/",
