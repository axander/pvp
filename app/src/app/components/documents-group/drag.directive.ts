...
import { DragService } from '../documents-group/drag.service';
...
export class DraggableDirective implements OnInit, OnDestroy {
  ...
  @Output() public onDragStartComplete: EventEmitter<DraggableEventObject> = new EventEmitter();
...
export interface DraggableEventObject {
  data?: any;
  zone?: any;
  id?: number;
}