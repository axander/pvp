...
export class DroppableDirective implements OnInit, OnDestroy {
  ...
  @Output() public onDroppableOver: EventEmitter<DroppableEventObject> = new EventEmitter();
  @Output() public onDragEventCss: EventEmitter<DroppableEventObject> = new EventEmitter();
  // 3
