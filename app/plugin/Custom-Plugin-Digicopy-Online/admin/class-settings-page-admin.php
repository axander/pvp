 ...
 * @package    Settings_Page
 * @subpackage Settings_Page/admin
 * @author     Alejandro M. Romero <axander_1973@hotmail.com>
 */
class Settings_Page_Admin {
	...
	public function addPluginAdminMenu() {
		...
		add_menu_page(  $this->plugin_name, 'CPDO', 'administrator', $this->plugin_name, array( $this, 'displayPluginAdminDashboard' ), 'dashicons-chart-area', 26 );
		
		//add_submenu_page( '$parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function );
		add_submenu_page( $this->plugin_name, '', 'Settings', 'administrator', $this->plugin_name.'-settings', array( $this, 'displayPluginAdminSettings' ));
	}
	...
	public function settingsPageSettingsMessages($error_message){
		switch ($error_message) {
				case '1':
						$message = __( 'There was an error adding this setting. Please try again.  If this persists, shoot us an email.', 'my-text-domain' );                 $err_code = esc_attr( 'settings_CPDO_setting' );                 $setting_field = 'settings_CPDO_setting';                 
						break;
		}
		$type = 'error';
		add_settings_error(
